...
echo'                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        ...
                        <li><a href="shop-account.php">Mi Cuenta</a></li>
                        <li><a href="shop-wishlist.php">Lista de Deseos</a></li>
                        <li><a href="shop-checkout.php">Pedidos</a></li>';
...
?>
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="shop-index-header-fix.php"><img src="assets/corporate/img/logos/blshoes.png" alt="BLSHOES" width="80"></a>

        <a href="javascript:void(0);" class="mobi-toggler"><i class="fa fa-bars"></i></a>

        <!-- INICIO CARRITO -->
<?php
$sqlsumarticulos='SELECT SUM(c_cantidad), SUM(c_cantidad*c_precio) FROM carrito WHERE 
c_usuario="'.$_SESSION['uid'].'"';
$resultsqlsumaarticulos=mysql_query($sqlsumarticulos) or die('linea 154');
while($row=mysql_fetch_array($resultsqlsumaarticulos)){
  $cantidadart=$row['SUM(c_cantidad)'];
  $total=$row['SUM(c_cantidad*c_precio)'];
}
 echo'       
        <div class="top-cart-block">
          <div class="top-cart-info">
            <a href="javascript:void(0);" class="top-cart-info-count">'.$cantidadart.' &nbsp;Articulos</a>
            <a href="javascript:void(0);" class="top-cart-info-value">$'.number_format($total,2).'</a>
          </div>
...
$sqlshowarticulos='SELECT * FROM carrito WHERE c_usuario="'.$_SESSION['uid'].'"';
$resultsqlshowarticulos=mysql_query($sqlshowarticulos) or die('linea 173');
while($row=mysql_fetch_array($resultsqlshowarticulos)){
  $cantidad=$row['c_cantidad'];
  $articulo=$row['c_articulo'];
  ...
  echo'                <li>
                  ...
                  <span class="cart-content-count">x '.$cantidad.'</span>
                  <strong><a href="shop-item.html">'.$articulo.'</a></strong>
                  <em>$'.$precio.'</em>
...
?>
        ...
        <div class="header-navigation">
          <ul>
            ...
            <li><a href="shop-item.php">NIÑOS</a></li>
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="shop-index-header-fix.php">Home Header Fixed</a></li>
                    ...
                    <div class="container">
                        <div class="carousel-position-four text-center">
                            <h2 class="margin-bottom-20 animate-delay carousel-title-v3 border-bottom-title text-uppercase" data-animation="animated fadeInDown">
                                Tonos de <br/><span class="color-red-v2">Caracteristicas</span><br/> designados
                            </h2>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 sale-product">
            ...
            <div class="owl-carousel owl-carousel5">
              <!-- INICIO ITEM(ARTICULO)-->
<?php
             include ('db.php');
             include('funciones.php');
             $sql1='SELECT * FROM articulos WHERE a_marca="D28" and a_catalogoactual="5" LIMIT 8';
             ...
             $nmarca=busca($marca,'marcas','m_id','m_nmb');

             echo '
             <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img width="80px" height="80px" src="assets/pages/img/products/img/'.$codigo.'.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                    <div>
                      <a href="assets/pages/img/products/img/'.$codigo.'.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <form target="#product-pop-up">
                      <input type="hidden" value="'.$codigo.'" name="id">
                      <input type="submit" onclick="mostrarVentana()" class="btn btn-default fancybox-fast-view">
                      </form>
                      

                    </div>
                  </div>
                  <h3><a href="shop-item.html"></a>'.$articulo.'-'.$nmarca.'</h3>
                  <div class="pi-price">$'.number_format($precio,2).'</div>';
               if($_SESSION['uid']!=''){   
               echo'<a href="javascript:;" class="btn btn-default add2cart">AGREGAR AL CARRITO</a>
                  ';
                }
 ...
 echo'             <!--FIN ITEM(ARTICULO) -->
              </div>
              <!--FIN CARROUSEL ARTICULOS -->
             </div>
          </div>';
 $id=$_POST['id'];
 if($id!=''){
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-3">
                  <div class="product-main-image">
                    <img src="assets/pages/img/products/img/'.busca($id,'articulos','a_id','a_nmb').'.jpg" alt="Cool green dress with red bell" class="img-responsive">
                  </div>
...
{
    var ventana = document.getElementById('product-pop-up');
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 steps-block-col">
            ...
            <div>
              <h2>ENVIOS EXPRÉS</h2>
              <em>Entrega dentro de 3-6 días</em>
            </div>
            <span>&nbsp;</span>
          </div>
          <div class="col-md-4 steps-block-col">
            ...
            <div>
              <h2>ENVIOS GRATIS</h2>
              <em>en compras mayores a $899</em>
            </div>
            <span>&nbsp;</span>
          </div>
          <div class="col-md-4 steps-block-col">
            ...
            <div>
              <h2>477 505 8877</h2>
              <em>Atención al cliente disponible 24/7</em>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 padding-top-10">
            2018 © BLSHOES. ALL Rights Reserved. 
          </div>
          <!-- END COPYRIGHT -->
          <!-- BEGIN PAYMENTS -->
...
<?php
// $sql1='SELECT * FROM articulos WHERE a_marca="D28" AND a_catalogoactual="5" ';
//              $resultsql1=mysql_query($sql1) or die ('linea 508');
//              while($row=mysql_fetch_array($resultsql1)){
//              $codigo=$row['a_id'];
//              $articulo=$row['a_nmb'];
