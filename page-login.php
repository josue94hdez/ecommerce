...
echo busca('DIANA','usuarios','u_nombre','u_apellido');
...
?>
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        ...
                        <li><a href="shop-wishlist.php">Mi Lista de Deseos</a></li>
                        <li><a href="shop-checkout.php">Revisar Pedidos</a></li>
                        <li><a href="page-login.php">Entrar</a></li>
                    </ul>
                </div>
                <!-- END TOP BAR MENU -->
            </div>
                ...
                <div id="checkout-content" class="panel-collapse collapse in">
                  <div class="panel-body row">
                    ...
                    <div class="col-md-6 col-sm-6">
                      ...
                      <p></p>
<?php
echo'                      <form method="post" action="verificarlogin.php">
...
<?php
$name=busca('JOSUE','usuarios','u_id','u_mail');
                  ...
                  <div class="panel-body row">
                    ...
                    <div class="col-md-6 col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="post-code" name="post-code" class="form-control" required>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="col-md-12">                      
                      ...
                      <button class="btn btn-primary  pull-right" type="submit" data-toggle="collapse" data-parent="#checkout-page" data-target="#shipping-address-content" id="button-payment-address">Continuar</button>
                      <div class="checkbox pull-right">
                        <label>
                          <input type="checkbox" name="terms" required> Acepto los terminos y condiciones <a title="Privacy Policy" href="javascript:;">Privacy Policy</a> &nbsp;&nbsp;&nbsp; 
                        </label>
                      </div>                        
                    </div>
                  </div>
