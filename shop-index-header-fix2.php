            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        ...
                        <li><a href="shop-wishlist.html">Mi Lista de Deseos</a></li>
                        <li><a href="shop-checkout.html">Revisar Pedidos</a></li>
      ...
      <div class="container">
        ...
        <div class="header-navigation">
          <ul>
            ...
            <li><a href="shop-item.html">NIÑOS</a></li>
            ...
            <div class="product-page product-pop-up">
              <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-9">
                  <h2>Cool green dress with red bell  <?php echo $_GET['id']; ?> </h2>
