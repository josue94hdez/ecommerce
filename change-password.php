...
if($estatus=='A'){
echo '<form method="post" action="editestatuspass.php">';  
                  ...
                  <div class="panel-body row">
                    <div class="col-md-6 col-sm-6">
                      ...
                      <div class="form-group">
                        <label for="firstname">Ingresa tu contraseña actual <span class="require">*</span></label>
...
echo '<form method="post" action="cambiarcontrasenia.php">';  
 echo'             <div id="payment-address" class="panel panel-default">
                <div class="panel-heading">
                  <h2 class="panel-title">
                    <a data-toggle="collapse" data-parent="#checkout-page" href="#payment-address-content" class="accordion-toggle">
                    ...
                    <div class="col-md-6 col-sm-6">
                      ...
                      <div class="form-group">
                        <label for="firstname">Escribe tu nueva contraseña <span class="require">*</span></label>
                        <input type="text"  id="password" name="password" class="form-control" required>
                      </div>
                      
                      
                                            
                      <input type="hidden" value="'.$_SESSION['uid'].'" name="usuario2">
