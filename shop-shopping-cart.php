...
echo'    <div class="row margin-bottom-40">
          <div class="col-md-12 col-sm-12">
            ...
            <div class="owl-carousel owl-carousel4">
              <div>
              ';
$sqlarticulos='SELECT * FROM articulos LIMIT 1';
     $resultsqlarticulos1=mysql_query($sqlarticulos) or die('linea 499');
      while($row=mysql_fetch_array($resultsqlarticulos1)){
        $aid=$row['a_id'];
        $anombre=$row['a_nombre'];
        $aprecio=$row['a_precio'];
        $atallas=$row['a_tallas'];
        $amarca=$row['a_marca'];
        $atipo=$row['a_tipo'];             
echo'         <div class="product-item">
                <div class="product-item">
                  ...
                  <h3><a href="shop-item.html">'.$anombre.'</a></h3>
                  <div class="pi-price">$'.$aprecio.'</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
